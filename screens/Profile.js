...
export default class Profile extends Component {
  ...
  constructor(props){
    super(props)
    this.state={fontsLoaded:false, isEnabled:false, light_theme:true, name:''}
  }
      ...
      <View style={this.state.light_theme ? styles.containerLight : styles.container}>
        ...
        <View style={styles.appTitle}>
          ...
          <View style={styles.appTitleTextContainer}>
            <Text style={this.state.light_theme ? styles.appTitleTextLight : styles.appTitleTextContainer}>Storytelling App</Text>
          </View>
        </View>
